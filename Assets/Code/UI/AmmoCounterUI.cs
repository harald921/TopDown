...
public class AmmoCounterUI : MonoBehaviour
{
    ...
    {
        float reloadTime = _weaponComponent.heldWeapon.ammoComponent.stats.reloadTime;
    ...
    void UpdateText()
    {
        ...
        int    currentAmmo = heldWeapon.ammoComponent.currentAmmo;
        int    maxAmmo     = heldWeapon.ammoComponent.stats.maxAmmo;
